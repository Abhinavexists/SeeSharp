...
def main():
    ...
    print(
        f"  python test_interface.py --frames {test_dir}/circles_sequence/frame_1.png {test_dir}/circles_sequence/frame_2.png {test_dir}/circles_sequence/frame_3.png"
    )
